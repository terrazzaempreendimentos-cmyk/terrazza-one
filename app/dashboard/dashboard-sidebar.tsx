...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Usuários", icon: UserCog, disabled: true, badge: "Em desenvolvimento" },
      { label: "Perfis", icon: ShieldCheck, disabled: true, badge: "Em desenvolvimento" },
      {
        label: "Integrações",
      ...
      { label: "Diagnóstico", icon: Gauge, disabled: true, badge: "Em desenvolvimento" },
      { label: "Logs", icon: ListChecks, disabled: true, badge: "Em desenvolvimento" },
      {
        label: "Testes OpenAI",
        icon: FlaskConical,
        disabled: true,
