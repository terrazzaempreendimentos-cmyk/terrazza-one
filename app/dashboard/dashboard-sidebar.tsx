...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    icon: Settings,
    links: [
      { label: "Visao administrativa", href: "/dashboard/administracao", icon: Settings, permission: "timeline.visualizar" },
      { label: "Usuarios e acessos", href: "/dashboard/administracao/usuarios", icon: UserCog, permission: "usuarios.administrar" },
      { label: "Timeline", href: "/dashboard/administracao/timeline", icon: ScrollText, permission: "timeline.visualizar" },
      { label: "Configuracoes", href: "/dashboard/administracao/configuracoes", icon: SlidersHorizontal, permission: "configuracoes.administrar" },
