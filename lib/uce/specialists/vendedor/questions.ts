...
export const vendedorQuestions: UCENextQuestion[] = [
  ...
  { field: "valorEsperado", text: "Qual valor voce espera pela venda?", reason: "Valor esperado indica posicionamento." },
  ...
  { field: "imovelOcupado", text: "O imovel esta ocupado?", reason: "Ocupacao afeta visita e estrategia." },
